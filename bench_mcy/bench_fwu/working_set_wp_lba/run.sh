...
result_file="bw_wp_4K.csv"
#result_file="bw_wp_20_20_200.csv"
...
#for i in `seq 1 20`
do
    echo  $bench_bin/random_script_gen.sh $i -1 8 
    $bench_bin/random_script_gen.sh $i -1 8  > rand_large_$i.job
